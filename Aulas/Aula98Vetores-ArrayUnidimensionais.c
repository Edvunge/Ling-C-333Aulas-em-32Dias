...
int main() {
		...
		Observe que não foi informado o tamanho mas foi informado um conjunto de dados. 
		Neste caso o vetor terá o mesmo tamanho do conjunto informado, tamanho 5.
		*/
		int num2[] = {1,2,3,4,5};
		...
		Neste caso as duas posições finais do vetor, índices 3 e 4, serão preenchidas com zero.
		*/
		int num3[5] = {1,2,3};
		...
		Neste caso é considerado o tamanho informado entre o par de colchetes. 
		Assim, os elementos excedentes no conjunto serão perdidos, neste caso e elemento 6.
		*/
		int num4[5] = {1,2,3,4,5,6};
		
		/* vetor do tipo inteiro chamado num5. 
		Observe que foi informado o tamanho do vetor e um conjunto de dados menor que o tamanho do vetor. 
		Neste caso, como já vimos, as demais posições serão preenchidas com zero, 
